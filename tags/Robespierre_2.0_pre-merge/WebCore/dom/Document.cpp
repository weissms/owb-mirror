...
Document::~Document()
{
    ...
    m_xml->xmlFreeDoc((BTXMLDoc *)m_transformSource);
#else
...
#ifdef __OWB__
MouseEventWithHitTestResults Document::prepareMouseEvent(const HitTestRequest& request, const IntPoint& documentPoint, const BIMouseEvent& event)
#else

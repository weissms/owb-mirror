...
void* my_pthread_getattr_np(pthread_t thread, pthread_attr_t *attr);
...
#elif __OWB_UCLIBC__
        void* stack = my_pthread_getattr_np(thread, &sattr);

...
/* -------- WebKitTools/TYPES TABLE (BEGIN) -------- WebKitTools/*/

static swig_type_info *swig_types[1];

/* -------- WebKitTools/TYPES TABLE (END) -------- WebKitTools/*/
...
/* -------- WebKitTools/TYPE CONVERSION AND EQUIVALENCE RULES (BEGIN) -------- WebKitTools/*/
...
/* -------- WebKitTools/TYPE CONVERSION AND EQUIVALENCE RULES (END) -------- WebKitTools/*/

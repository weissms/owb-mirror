...
#if ENABLE(CEHTML)
        noninherited_flags._inputFormat = initialInputFormat();
#endif
    }
...
#if ENABLE(DAE)
    void setNavDown(const NavigationAtom& navDown) { rareNonInheritedData.access()->navInfo.m_navDown = navDown; }
    void setNavLeft(const NavigationAtom& navLeft) { rareNonInheritedData.access()->navInfo.m_navLeft = navLeft; }
    void setNavRight(const NavigationAtom& navRight) { rareNonInheritedData.access()->navInfo.m_navRight = navRight; }
    void setNavUp(const NavigationAtom& navUp) { rareNonInheritedData.access()->navInfo.m_navUp = navUp; }

    const NavigationAtom& navDown() { return rareNonInheritedData.access()->navInfo.m_navDown; }
    const NavigationAtom& navLeft() { return rareNonInheritedData.access()->navInfo.m_navLeft; }
    const NavigationAtom& navRight() { return rareNonInheritedData.access()->navInfo.m_navRight; }
    const NavigationAtom& navUp() { return rareNonInheritedData.access()->navInfo.m_navUp; }
#endif

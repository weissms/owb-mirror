...
bool Node::dispatchKeyEvent(const PlatformKeyboardEvent& key, bool* eventFlowAltered)
{
...
#if ENABLE(DAE)
        if (eventFlowAltered)
            *eventFlowAltered = keyboardEvent->propagationStopped() || keyboardEvent->cancelBubble();
#endif

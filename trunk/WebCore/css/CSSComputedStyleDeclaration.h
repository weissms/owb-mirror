...
#if ENABLE(CEHTML)
    PassRefPtr<CSSValue> getCEHTMLPropertyCSSValue(int propertyID, EUpdateLayout) const;
#endif
#if ENABLE(DAE)
    PassRefPtr<CSSValue> getDAEPropertyCSSValue(int propertyID, EUpdateLayout) const;
#endif

...
void GraphicsLayerQt::setNeedsDisplayInRect(const FloatRect&)
{
}

bool GraphicsLayerQt::animateTransform(const TransformValueList&, const IntSize&, const Animation*, double beginTime, bool isTransition)
{
    return false;
}

bool GraphicsLayerQt::animateFloat(AnimatedPropertyID, const FloatValueList&, const Animation*, double beginTime)
{
    return false;
}

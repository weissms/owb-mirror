...
bool GIFImageReader::read(const unsigned char* buf, unsigned len, 
                     BCGIFImageDecoder::GIFQuery query, unsigned haltAtFrame)
{
    if (!len)
        return false;
    ...
    for (;len >= bytes_to_consume; q=buf) {
        ...
        case gif_global_header:
            ...
            */
            ...
            if ((q[4] & 0x80) && global_colormap_size > 0) { /* global map */
                ...
                if (query != BCGIFImageDecoder::GIFFrameCountQuery)
        ...
        case gif_image_header:
            ...
            */
            ...
            if (query == BCGIFImageDecoder::GIFSizeQuery || haltAtFrame == static_cast<unsigned>(images_decoded)) {
            ...
            if (query == BCGIFImageDecoder::GIFFullQuery && !frame_reader)
                frame_reader = new GIFFrameReader();
